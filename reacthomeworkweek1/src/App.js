...
function App() {
    ...
    const TodoItemStatic = (props) => {
        return <li>Activity: {props.todoStaticName},<br/> Time: {props.todoStaticTime}
            <br/> Deadline: {props.todoStaticDeadline}</li>
    };
        ...
        <div className="App">
            <section>
                ...
                <article>
                    ...
                    <ul>
                        <TodoItemStatic todoStaticName="Get out of bed" todoStaticTime="09:00"
                                        todoStaticDeadline="Wed Aug 1 2019"/>
                        <TodoItemStatic todoStaticName="Brush teeth" todoStaticTime="09:10"
                                        todoStaticDeadline="Wed Aug 1 2019"/>
                        <TodoItemStatic todoStaticName="Change clothes" todoStaticTime="09:15"
                                        todoStaticDeadline="Wed Aug 1 2019"/>
                        <TodoItemStatic todoStaticName="Eat breakfast" todoStaticTime="09:15"
                                        todoStaticDeadline="Wed Aug 1 2019"/>
                    </ul>
                </article>
            </section>
